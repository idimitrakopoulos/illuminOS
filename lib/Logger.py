class Logger:
    ...
    def __init__(self, log_level):
        ...
        self.debug("Logging level set to [{}] ({})".format(log_level, str(self.log_level_id)))
    ...
    def trace(self, msg):
        if self.log_level_id == 0:
            print("[{}] {}".format(self.log_levels[0][1], str(msg)))

    def debug(self, msg):
        if self.log_level_id <= 1:
            print("[{}] {}".format(self.log_levels[1][1], str(msg)))

    def info(self, msg):
        if self.log_level_id <= 2:
            print("[{}] {}".format(self.log_levels[2][1], str(msg)))

    def warn(self, msg):
        if self.log_level_id <= 3:
            print("[{}] {}".format(self.log_levels[3][1], str(msg)))

    def error(self, msg):
        if self.log_level_id <= 4:
            print("[{}] {}".format(self.log_levels[4][1], str(msg)))

    def fatal(self, msg):
        if self.log_level_id <= 5:
            print("[{}] {}".format(self.log_levels[5][1], str(msg)))
